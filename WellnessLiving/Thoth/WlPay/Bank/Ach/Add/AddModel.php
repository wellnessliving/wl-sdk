 ...
 *
 * @method WlModelRequest delete() Deletes saved ACH.  Removes the ACH bank account identified by `k_pay_bank` from the pay owner's saved payment methods  for the given business.
 * @method WlModelRequest get() Gets widget for ACH account add.  Validates the locale, business, and pay owner, then determines whether to use Direct Entry (Australia and New  Zealand) or ACH as the payment method. Returns the rendered widget HTML and the processor ID for the  resolved merchant.
 * @method WlModelRequest post() Saves new ACH pay method.  Processes the submitted ACH widget data, saves the bank account under the given pay owner and business,  and optionally marks it as the default payment method. Returns the saved account details including billing  address information.
 */

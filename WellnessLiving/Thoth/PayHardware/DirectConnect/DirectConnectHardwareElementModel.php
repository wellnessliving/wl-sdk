...
/**
 * Endpoint for operations with paragon hardware.
 *
 * @method WlModelRequest delete() Removes terminal.
 * @method WlModelRequest get() Fetch terminal information.
 * @method WlModelRequest post() Creates or updates terminal.
 */
class DirectConnectHardwareElementModel extends WlModelAbstract
{
  /**
   * Hardware model ID.
   *

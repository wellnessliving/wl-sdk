 ...
 *
 * @method WlModelRequest get() Gets Stripe charge information.  Validates the business merchant and payer, retrieves the charge from Stripe by its charge id, and returns the payment method used along with the payment method details captured at the time of the transaction.
 */

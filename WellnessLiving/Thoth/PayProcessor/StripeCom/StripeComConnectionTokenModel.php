 ...
 *
 * @method WlModelRequest post() Gets a secret from a connection token for the Stripe Terminal SDK.  Validates the business merchant, the payer, and that the currency supports point-of-sale payments, then creates a Stripe Terminal connection token, optionally scoped to the given location, and returns its secret.
 */

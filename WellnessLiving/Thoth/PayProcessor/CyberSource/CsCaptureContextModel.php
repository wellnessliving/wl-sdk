 ...
 *
 * @method WlModelRequest post() Generates a capture context for `CyberSource` Flex Microform.  Returns a capture context and key ID that the client uses to encrypt the card number before  sending it in the follow-on Tokenize Card request.
 */

 ...
 *
 * @method WlModelRequest post() Checks `CyberSource` Payer Authentication enrollment.  Verifies whether the payer must complete additional authentication steps for the transaction  started by {@link \Thoth\PayProcessor\CyberSource\CsPaSetupApi}, returning a JWT and interaction URL when a challenge is required.
 */

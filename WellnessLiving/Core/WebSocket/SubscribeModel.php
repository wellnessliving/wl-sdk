...
<dl>
  <dt>array `a_data`</dt>
  <dd>
    New information for messenger. <dl>
      <dt>array `message`</dt>
      <dd>
        Message information:
<dl>
...
<dl>
  <dt>array `a_visit`</dt>
  <dd>
    New data of changes schedule item: <dl>
      <dt>string `dtl_end`</dt>
...
Empty array if the business does not have a mail domain set up. <dl>
      <dt>int `id_status`</dt>
...
<dl>
  ...
  <dd>
    List of users for which address verification failed. <dl>
  ...
  <dt>array `a_valid`</dt>
  <dd>
    List of users for which address verification succeed. <dl>
      <dt>string `a_address`</dt>
      <dd>
        Address information. 
          <dt>string `text_address`</dt>
...
<dl>
  <dt>array `a_info`</dt>
  <dd>
    An array with information about SMS: <dl>
...
<dl>
  <dt>array `a_info`</dt>
  <dd>
    An array with information about dialog: <dl>

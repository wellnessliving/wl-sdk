 ...
 *
 * @method WlModelRequest get() Retrieves information about users by email.  Searches for users with the given email address (or an email inherited from a relative)  across every business in the franchise, and returns their profile, address, and contact  information keyed by a combination of business key and UID.
 */
 ...
 *
 * <dl>
 *   <dt>array<string, int> `a_relation`</dt>
 *   <dd>
 *     Relation between the user and family members. Keys are UIDs of relatives, values -
 * relation type from {@link WlFamilyRelationSid}.
 *   </dd>
 * 
 *   <dt>int `id_gender`</dt>
 *   <dd>
 *     Gender type, One of {@link GenderSid} constants. Empty means that client is not selected gender type.
 *   </dd>
 * 

 ...
 *
 * @method WlModelRequest get() Gets information about the appointment and wait list.  Returns the appointment or asset title, location, staff, and time slot, together with the  ordered list of visits currently on the wait list, each with client, note, addon, resource  and answer details. Also returns which notification channels are enabled for wait list mail.
 */

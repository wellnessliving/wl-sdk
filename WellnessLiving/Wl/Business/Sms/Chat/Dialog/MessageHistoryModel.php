 ...
 *
 * @method WlModelRequest get() Retrieves SMS message history with a specific client.  Returns up to `i_limit` messages exchanged with the client in the given business, ordered  from most recent to oldest. Pass `k_sms_history_last` to page backward and load older  messages sent before that message.
 */

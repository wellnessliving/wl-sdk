 ...
 *
 * @method WlModelRequest get() Retrieves the list of SMS chat dialogs for a business.  Returns dialogs ordered by the date of the last SMS activity, optionally narrowed by  `s_filter` criteria (location, login type, date range, and dialog status) and paginated  using `dtl_last_activity` as a cursor for loading older results.
 */

 ...
 * Last ID: 15.
 */
class MarketingSuiteUnsubscribeReasonSid
{
  /**
  ...
  /**
   * Does not fit how the business markets itself.
   *
   * @title It doesn't fit how I market my business
   */
  const NOT_FIT_MARKETING = 14;
   ...
   *
   * @title The setup process felt too complicated
   */
  const SETUP_TOO_COMPLICATED = 13;

  /**
   * Uses another marketing platform.
   *
   * @title I use another marketing platform
   */

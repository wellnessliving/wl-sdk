 ...
 *
 * @method WlModelRequest get() Checks whether the current user is allowed to reserve the specified class, service, or appointment.  Validates the schedule, date, and time input, then checks login permission for the requested  reservation at the given date and time using the schedule's location timezone. Also determines  whether the current user is a franchise traveller for the business.
 */

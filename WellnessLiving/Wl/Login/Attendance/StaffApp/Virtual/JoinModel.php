 ...
 *
 * @method WlModelRequest get() Gets information about the virtual service the client is joining.  Validates that the specified class period or appointment is a virtual service the current user  may access, then returns the service name, its scheduled start time in UTC and local time,  whether the business uses FitLIVE, and the redirect URL to the virtual meeting.
 */

 ...
 *
 * @method WlModelRequest get() Returns information about SMS settings.  Reports whether a business phone number is configured, whether SMS and SMS notifications  are enabled, whether A2P10DLC registration is due and, if so, the message to show the  user, and whether a regulatory bundle submission is still required for the business.
 */

 ...
 *
 * @method WlModelRequest get() Gets quizzes for the selected purchase options.  Resolves the quizzes required or available for the services behind the given purchase items,  taking into account quizzes already completed by the specified user, and returns them so the  client can collect answers before booking is finished.
 */

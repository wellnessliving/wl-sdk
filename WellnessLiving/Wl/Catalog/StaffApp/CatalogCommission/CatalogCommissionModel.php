 ...
 *
 * @method WlModelRequest get() Retrieves the list of staff members eligible for commission along with the default staff commission for the current client.  Checks that the actor has access to the business and that commission-based payment is  enabled. When enabled, loads the default staff commission assigned to the given client  and the list of staff members with commission enabled, including their commission rates.  For a small set of legacy applications, also returns the deprecated `k_staff` field for  backward compatibility.
 */

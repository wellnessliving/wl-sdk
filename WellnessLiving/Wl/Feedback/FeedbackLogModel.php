 ...
 *
 * @method WlModelRequest post() Logs feedback from the mobile application.  Validates the input data, then writes a log entry recording whether the user is satisfied with the action, together with the location, device, and application details supplied by the mobile application.
 */
class FeedbackLogModel extends WlModelAbstract
{
  ...
  /**
   * The source of the action. A constant of {@link ModeSid}.
   *

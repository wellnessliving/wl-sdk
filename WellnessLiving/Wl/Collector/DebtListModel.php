...
class DebtListModel extends WlModelAbstract
{
   ...
   *
   * If left `null` and {@link \WellnessLiving\Wl\Collector\DebtListModel::$dl_start} has been specified, only debt payments added before this date will be returned.

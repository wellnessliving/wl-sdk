...
use WellnessLiving\Wl\Collector\DebtStatusSid;

/**
 * Api endpoint designed to retrieve debt status of particular user.
 *
 * @method WlModelRequest get() Retrieves the debt status of the specified user within the business.  Validates the business, the user, the current subscription, and access privileges, then loads the current debt status: days past due, current and future debt amounts, collection dates, and any comment.
 */
 ...
 * One of {@link DebtStatusSid} constants.
 *

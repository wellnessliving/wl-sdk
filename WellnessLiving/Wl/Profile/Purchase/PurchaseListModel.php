...
class PurchaseListModel extends WlModelAbstract
{
   ...
   *   <dd>The ID of the purchase type. One of the constants {@link WlPurchaseItemSid}.</dd>
   * 
   *   <dt>int `id_sale`</dt>
   *   <dd>The ID of the sale category in the store. One of the constants {@link WlSaleSid}.</dd>
   * 
   *   <dt>bool `is_active`</dt>
   *   <dd>If `true`, then the purchase item is active. Otherwise, this will be `false`.</dd>
   * 
   *   <dt>bool `is_component`</dt>
   *   <dd>If `true`, then the purchase item is a package component. Otherwise, this will be `false`.</dd>
   * 
   ...
   * This is used only if the event is part of a package.</dd>
   * 
   *   <dt>string `k_login_promotion`</dt>
   *   <dd>The key of the user's existing purchase options.
   * This is used only if `k_code` and `k_purchase` are empty.</dd>
   * 

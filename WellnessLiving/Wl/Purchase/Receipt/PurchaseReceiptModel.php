...
/**
 * Retrieves information about purchase for a receipt.
 */
class PurchaseReceiptModel extends WlModelAbstract
{
   ...
   *   <dd>Rest amount on user account.</dd>
   *   <dt>string <var>text_currency</var></dt>
   *   <dd>Currency of the amount.</dd>
   *   <dt>string <var>text_method</var></dt>
   ...
   *       <dd>Whether image is empty.</dd>
   *       <dt>string <var>text_url</var></dt>
   ...
   * <dl>
   *   <dt>string <var>text_card_number</var></dt>
   *   <dd>Card or account number.</dd>
   *   <dt>string <var>text_card_system</var></dt>
   *   <dd>Card system name from {@link \WellnessLiving\Core\a\ACardSystemSid}.</dd>
   *   <dt>string <var>text_title</var></dt>
   *   <dd>Payment account title. 'Account number' for ACH, Card for all other.</dd>
   * </dl>
   *
   * @get result
   * @var array[]
   ...
   * <dl>
   *   <dt>string <var>m_amount</var></dt>
   *   <dd>Amount of the payment.</dd>
   *   <dt>string <var>text_currency</var></dt>
   *   <dd>Currency of the amount.</dd>
   *   <dt>string <var>text_pay_method</var></dt>
   *   <dd>Payment method title.</dd>
   * </dl>
   *
   * @get result
   ...
   *   <dd>Discount amount for a discount code.</dd>
   *   <dt>string <var>m_sum</var></dt>
   *   <dd>Subtotal amount - sum of the prices.</dd>
   *   <dt>string <var>m_tax</var></dt>
   *   <dd>Taxes amount.</dd>
   *   <dt>string <var>m_tip</var></dt>
   *   <dd>Tip amount.</dd>
   *   <dt>string <var>m_total</var></dt>
   *   <dd>Total amount.</dd>
   *   <dt>string <var>text_currency</var></dt>
   *   <dd>Currency of the purchase.</dd>
   *   <dt>string <var>text_discount_code</var></dt>
   *   <dd>Discount code applied to the purchase.</dd>
   * </dl>
   *
   * @get result
   * @var array
   ...
   *   <dd>Count of items in the purchase.</dd>
   *   <dt>string <var>m_price</var></dt>
   *   <dd>Price of the single item.</dd>
   *   <dt>string <var>m_price_total</var></dt>
   *   <dd>Price of all items.</dd>
   *   <dt>string <var>text_category</var></dt>
   *   <dd>Type of the item: product, class pass, etc.</dd>
   *   <dt>string <var>text_currency</var></dt>
   *   <dd>Currency of the price.</dd>
   *   <dt>string <var>text_info</var></dt>
  ...
  /**
   * HTML representation of purchase receipt. It's ready to print.
   *
   * @get result
   * @var string
   */

 ...
 *
 * @method WlModelRequest get() Returns current session environment.  Determines the current business, location, and user for the session, taking into account the  application type, franchise settings, and multi-datacenter routing, and returns the resulting  environment data used to bootstrap the client application.
 * @method WlModelRequest put() Saves current location of business for current user.  Switches the current business and location for the session, forwarding the request to another  data center when the target business is hosted elsewhere.
 */
class EnvironmentModel extends WlModelAbstract
{
  ...
  /**
   * Business locale. One of {@link LocaleSid} constants.
   *
   * @get result
   * @var int
   */
  ...
  /**
   * Country code for business locale {@link LocaleSid} constants.
   *
   * @get result
   * @var string
   */

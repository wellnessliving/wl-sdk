 ...
 *
 * @method WlModelRequest get() Gets visit status.  Checks the specified visit against the business late cancellation and no show rules,  returning the fee amount that would be charged, whether the visit is blamed, and whether  a confirmation modal must be shown before charging the fee.
 */

 ...
 *
 * @method WlModelRequest get() Loads the list of online store categories for the business.  Returns the active shop categories configured for the business, together with their order,  title and description. The result is left unset when the business has no shop categories.
 */

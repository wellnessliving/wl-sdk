 ...
 *
 * @method WlModelRequest get() Gets list of schedule filters available for given user.  Returns the user's own filters together with public filters saved for the business, skipping  filters restricted to locations the user cannot access. Filter configurations are stored in  "mirror" format (deselected elements); this method converts them into the actual list of  selected classes, events, locations, assets, services, and staff members expected by the client.
 */
